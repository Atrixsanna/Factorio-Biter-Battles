...
function Public.forces()
    ...
    for _, force in pairs(game.forces) do
        ...
        game.forces[force.name].technologies['agricultural-science-pack'].enabled = false
        game.forces[force.name].technologies['cryogenic-science-pack'].enabled = false
        game.forces[force.name].technologies['promethium-science-pack'].enabled = false
        game.forces[force.name].technologies['electromagnetic-science-pack'].enabled = false
        game.forces[force.name].technologies['metallurgic-science-pack'].enabled = false
